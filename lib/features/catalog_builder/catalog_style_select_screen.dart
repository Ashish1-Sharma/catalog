...
class CatalogStyleSelectScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CatalogStyleSelectScreen> createState() => _CatalogStyleSelectScreenState();
}

class _CatalogStyleSelectScreenState extends ConsumerState<CatalogStyleSelectScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isList = builderState.type == 'list';

    final sections = isList
        ? [
            {
              'number': 1,
              'title': 'Simple List',
        ...
        : [
            {
              'number': 1,
              'title': 'Photo Only — 2 Columns',
              'asset': 'assets/grid_temp_1.png',
              'styleId': 1,
              'label': 'Style 1',
              'fallback': _buildGridPreview2x2OnlyPhoto(),
            },
            {
              'number': 2,
              'title': 'Photo + Price',
              'asset': 'assets/grid_temp_2.png',
              'styleId': 2,
              'label': 'Style 2',
              'fallback': _buildGridPreview2x2WithPrice(),
            },
            {
              'number': 3,
              'title': 'Photo + Price + Stock Qty',
              'asset': 'assets/grid_temp_3.png',
              'styleId': 3,
              'label': 'Style 3',
              'fallback': _buildGridPreview2x2WithPrice(),
            },
            {
              'number': 4,
              'title': 'Photo + Name + Price',
              'asset': 'assets/grid_temp_4.png',
              'styleId': 4,
              'label': 'Style 4',
              'fallback': _buildGridPreview2x2NameAndPrice(),
            },
            {
              'number': 5,
              'title': 'Photo + Price + Discount',
              'asset': 'assets/grid_temp_5.png',
              'styleId': 5,
              'label': 'Style 5',
              'fallback': _buildGridPreview2x2WithDiscount(),
            },
            {
              'number': 6,
              'title': 'Photo + Description + Price',
              'asset': 'assets/grid_temp_6.png',
              'styleId': 6,
              'label': 'Style 6',
              'fallback': _buildGridPreview2x2NameAndPrice(),
            },
            {
              'number': 7,
              'title': 'Photo + Badge + Price',
              'asset': 'assets/grid_temp_7.png',
              'styleId': 7,
              'label': 'Style 7',
              'fallback': _buildGridPreview2x2WithBadge(),
            },
            {
              'number': 8,
              'title': 'Photo + Category + Price',
              'asset': 'assets/grid_temp_8.png',
              'styleId': 8,
              'label': 'Style 8',
              'fallback': _buildGridPreview2x2NameAndPrice(),
            },
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              isList ? 'Choose Your List Style' : 'Choose Your Style',
            ...
            Text(
              isList ? 'Select a list template layout for your catalog' : 'Select a template layout for your catalog',
              style: const TextStyle(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text(isList ? 'Select a list template style for displaying your product rows.' : 'Select a template style to display your products.')),
              );
            },
          ),
        ],
  ...
  // Fallback Vector Previews for Grid
  static Widget _buildGridPreview2x2OnlyPhoto() {
    return GridView.count(
      ...
      crossAxisSpacing: 8,
      children: [
        _buildVectorProductIcon(Icons.sanitizer_outlined, const Color(0xFFFDE68A), const Color(0xFFD97706)),
        _buildVectorProductIcon(Icons.water_drop_outlined, const Color(0xFFA7F3D0), const Color(0xFF059669)),
        _buildVectorProductIcon(Icons.science_outlined, const Color(0xFFBAE6FD), const Color(0xFF0284C7)),
        _buildVectorProductIcon(Icons.face_outlined, const Color(0xFFFBCFE8), const Color(0xFFDB2777)),
      ],
    );
  }

  static Widget _buildGridPreview2x2WithPrice() {
    return GridView.count(
      crossAxisCount: 2,
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
      ...
      children: [
        _buildProductWithPrice(Icons.sanitizer_outlined, const Color(0xFFFDE68A), const Color(0xFFD97706), '₹299'),
        _buildProductWithPrice(Icons.water_drop_outlined, const Color(0xFFA7F3D0), const Color(0xFF059669), '₹499'),
        _buildProductWithPrice(Icons.science_outlined, const Color(0xFFBAE6FD), const Color(0xFF0284C7), '₹199'),
        _buildProductWithPrice(Icons.face_outlined, const Color(0xFFFBCFE8), const Color(0xFFDB2777), '₹350'),
      ],
    );
  }

  static Widget _buildProductWithPrice(IconData icon, Color bg, Color iconColor, String price) {
    return Column(
      children: [
        Expanded(child: _buildVectorProductIcon(icon, bg, iconColor)),
        const SizedBox(height: 2),
        Text(
          price,
  ...
  static Widget _buildGridPreview2x2WithDiscount() {
    return GridView.count(
      crossAxisCount: 2,
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
      ...
      children: [
        Stack(
          children: [
            _buildProductWithDiscount(Icons.sanitizer_outlined, const Color(0xFFFDE68A), const Color(0xFFD97706), '₹399', '₹299'),
            Positioned(
              top: 2,
              left: 2,
              child: Container(
                ...
                child: const Text('-25%', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
            ),
          ],
        ),
        _buildProductWithDiscount(Icons.water_drop_outlined, const Color(0xFFA7F3D0), const Color(0xFF059669), '₹599', '₹449'),
        _buildProductWithDiscount(Icons.science_outlined, const Color(0xFFBAE6FD), const Color(0xFF0284C7), '₹250', '₹180'),
        _buildProductWithDiscount(Icons.face_outlined, const Color(0xFFFBCFE8), const Color(0xFFDB2777), '₹400', '₹320'),
      ],
    );
  }

  static Widget _buildProductWithDiscount(IconData icon, Color bg, Color iconColor, String oldPrice, String newPrice) {
    return Column(
      children: [
        Expanded(child: _buildVectorProductIcon(icon, bg, iconColor)),
        const SizedBox(height: 2),
        Row(
          ...
          children: [
            Text(
              oldPrice,
              style: const TextStyle(fontSize: 8, color: Color(0xFF94A3B8), decoration: TextDecoration.lineThrough),
            ),
  ...
  static Widget _buildGridPreview2x2NameAndPrice() {
    return GridView.count(
      crossAxisCount: 2,
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
      ...
      children: [
        _buildProductNameAndPrice(Icons.sanitizer_outlined, const Color(0xFFFDE68A), const Color(0xFFD97706), 'Serum', '₹299'),
        _buildProductNameAndPrice(Icons.water_drop_outlined, const Color(0xFFA7F3D0), const Color(0xFF059669), 'Toner', '₹499'),
        _buildProductNameAndPrice(Icons.science_outlined, const Color(0xFFBAE6FD), const Color(0xFF0284C7), 'Lotion', '₹199'),
        _buildProductNameAndPrice(Icons.face_outlined, const Color(0xFFFBCFE8), const Color(0xFFDB2777), 'Cream', '₹350'),
      ],
    );
  }

  static Widget _buildProductNameAndPrice(IconData icon, Color bg, Color iconColor, String name, String price) {
    return Column(
      children: [
        Expanded(child: _buildVectorProductIcon(icon, bg, iconColor)),
        const SizedBox(height: 2),
  ...
  static Widget _buildGridPreview2x2WithBadge() {
    return GridView.count(
      crossAxisCount: 2,
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: const Text('HOT', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
            ),
          ],
        ),
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: const Text('BEST', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
            ),
          ],
        ),
  ...
  static Widget _buildVectorProductIcon(IconData iconData, Color bgColor, Color iconColor) {
    return Container(
      decoration: BoxDecoration(
        color: bgColor,
