...
class PhotoCategoryPriceTemplate implements GridCatalogTemplate {
  @override
  String get id => 'grid_photo_category_price';

  @override
  String get displayName => 'Photo + Category + Price';
  ...
  pw.Widget buildProductCard({
    ...
    final catName = (categoryName != null && categoryName.trim().isNotEmpty) ? categoryName.trim() : 'General';
